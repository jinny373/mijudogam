...
const KR_STOCK_MAP: Record<string, { name: string; market: "KS" | "KQ" }> = {
  ...
  // 한화그룹
  "009830": { name: "한화솔루션", market: "KS" },
  "000880": { name: "한화", market: "KS" },
  "012450": { name: "한화에어로스페이스", market: "KS" },
  "042660": { name: "한화오션", market: "KS" },
  "272210": { name: "한화시스템", market: "KS" },
  "088350": { name: "한화생명", market: "KS" },
  // HD현대그룹
  "267250": { name: "HD현대", market: "KS" },
  "322000": { name: "HD현대에너지솔루션", market: "KS" },
  "010620": { name: "HD현대미포", market: "KS" },
  "042670": { name: "HD현대인프라코어", market: "KS" },
  "009540": { name: "HD한국조선해양", market: "KS" },
  // 두산/방산
  "241560": { name: "두산밥캣", market: "KS" },
  "454910": { name: "두산로보틱스", market: "KS" },
  "336260": { name: "두산퓨얼셀", market: "KS" },
  "000150": { name: "두산", market: "KS" },
  "047810": { name: "한국항공우주", market: "KS" },
  "064350": { name: "현대로템", market: "KS" },
  // 제약/바이오
  "000250": { name: "삼천당제약", market: "KS" },
  "000100": { name: "유한양행", market: "KS" },
  "006280": { name: "GC녹십자", market: "KS" },
  "128940": { name: "한미약품", market: "KS" },
  "185750": { name: "종근당", market: "KS" },
  "069620": { name: "대웅제약", market: "KS" },
  "326030": { name: "SK바이오팜", market: "KS" },
  "207940": { name: "삼성바이오로직스", market: "KS" },
  // 에너지/건설
  "036460": { name: "한국가스공사", market: "KS" },
  "028050": { name: "삼성엔지니어링", market: "KS" },
  "047040": { name: "대우건설", market: "KS" },
  "006360": { name: "GS건설", market: "KS" },
  // 유통/식품
  "097950": { name: "CJ제일제당", market: "KS" },
  "139480": { name: "이마트", market: "KS" },
  "271560": { name: "오리온", market: "KS" },
  "004370": { name: "농심", market: "KS" },
  // 증권/보험
  "016360": { name: "삼성증권", market: "KS" },
  "071050": { name: "한국금융지주", market: "KS" },
  "005830": { name: "DB손해보험", market: "KS" },
  "138040": { name: "메리츠금융지주", market: "KS" },
  // 기타 대형
  "022100": { name: "포스코DX", market: "KS" },
  "402340": { name: "SK스퀘어", market: "KS" },
  "078930": { name: "GS", market: "KS" },
  "006260": { name: "LS", market: "KS" },
  "010120": { name: "LS일렉트릭", market: "KS" },
  "229640": { name: "LS에코에너지", market: "KS" },
  // 코스닥 확대
  "068760": { name: "셀트리온제약", market: "KQ" },
  "319660": { name: "피에스케이", market: "KQ" },
  "067310": { name: "하나마이크론", market: "KQ" },
  "089030": { name: "테크윙", market: "KQ" },
  "240810": { name: "원익IPS", market: "KQ" },
  "064760": { name: "티씨케이", market: "KQ" },
  "066970": { name: "엘앤에프", market: "KQ" },
  "122870": { name: "YG엔터", market: "KQ" },
  "253450": { name: "스튜디오드래곤", market: "KQ" },
  "042000": { name: "카페24", market: "KQ" },
  "012510": { name: "더존비즈온", market: "KQ" },
  "181710": { name: "NHN", market: "KQ" },
};
