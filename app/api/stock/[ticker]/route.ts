  ...
  try {
    ...
    const getRelatedStocks = async () => {
      ...
      const specificRelations: Record<string, { ticker: string; name: string; nameKo: string; reason: string }[]> = {
        "NVDA": [
          { ticker: "AMD", name: "AMD", nameKo: "AMD", reason: "GPU 경쟁사, PER 더 낮음" },
          { ticker: "TSM", name: "TSMC", nameKo: "TSMC", reason: "NVDA 칩 만들어주는 회사" },
          { ticker: "AVGO", name: "Broadcom", nameKo: "브로드컴", reason: "AI 네트워크 칩 강자" },
          { ticker: "MRVL", name: "Marvell", nameKo: "마벨", reason: "데이터센터 반도체" },
        ],
        "AAPL": [
          { ticker: "MSFT", name: "Microsoft", nameKo: "마이크로소프트", reason: "빅테크 라이벌" },
          { ticker: "GOOGL", name: "Alphabet", nameKo: "구글", reason: "스마트폰 OS 경쟁 (안드로이드)" },
          { ticker: "QCOM", name: "Qualcomm", nameKo: "퀄컴", reason: "모바일 칩 공급사" },
          { ticker: "TSM", name: "TSMC", nameKo: "TSMC", reason: "애플 칩 생산" },
        ],
        "TSLA": [
          { ticker: "RIVN", name: "Rivian", nameKo: "리비안", reason: "전기 픽업트럭 신생 기업" },
          { ticker: "LCID", name: "Lucid", nameKo: "루시드", reason: "프리미엄 전기차" },
          { ticker: "F", name: "Ford", nameKo: "포드", reason: "전기차 F-150 라이트닝" },
          { ticker: "GM", name: "General Motors", nameKo: "GM", reason: "전기차 전환 중" },
        ],
        "AMZN": [
          { ticker: "SHOP", name: "Shopify", nameKo: "쇼피파이", reason: "이커머스 플랫폼" },
          { ticker: "WMT", name: "Walmart", nameKo: "월마트", reason: "오프라인 유통 경쟁사" },
          { ticker: "MSFT", name: "Microsoft", nameKo: "마이크로소프트", reason: "클라우드 경쟁 (Azure vs AWS)" },
          { ticker: "GOOGL", name: "Alphabet", nameKo: "구글", reason: "클라우드 3위 (GCP)" },
        ],
        "GOOGL": [
          { ticker: "META", name: "Meta", nameKo: "메타", reason: "디지털 광고 경쟁사" },
          { ticker: "MSFT", name: "Microsoft", nameKo: "마이크로소프트", reason: "AI 검색 경쟁 (Bing)" },
          { ticker: "SNAP", name: "Snap", nameKo: "스냅", reason: "소셜 & 광고" },
          { ticker: "AMZN", name: "Amazon", nameKo: "아마존", reason: "광고 사업 급성장 중" },
        ],
        "MSFT": [
          { ticker: "GOOGL", name: "Alphabet", nameKo: "구글", reason: "클라우드 & AI 검색 경쟁" },
          { ticker: "CRM", name: "Salesforce", nameKo: "세일즈포스", reason: "기업용 소프트웨어 경쟁" },
          { ticker: "ORCL", name: "Oracle", nameKo: "오라클", reason: "클라우드 데이터베이스" },
          { ticker: "AMZN", name: "Amazon", nameKo: "아마존", reason: "클라우드 1위 AWS" },
        ],
        "META": [
          { ticker: "GOOGL", name: "Alphabet", nameKo: "구글", reason: "디지털 광고 1위" },
          { ticker: "SNAP", name: "Snap", nameKo: "스냅", reason: "젊은 층 소셜미디어" },
          { ticker: "PINS", name: "Pinterest", nameKo: "핀터레스트", reason: "이미지 소셜 & 쇼핑" },
          { ticker: "NFLX", name: "Netflix", nameKo: "넷플릭스", reason: "콘텐츠 경쟁 (릴스 vs 넷플)" },
        ],
        "AMD": [
          { ticker: "NVDA", name: "NVIDIA", nameKo: "엔비디아", reason: "GPU 시장 1위" },
          { ticker: "INTC", name: "Intel", nameKo: "인텔", reason: "CPU 경쟁사" },
          { ticker: "QCOM", name: "Qualcomm", nameKo: "퀄컴", reason: "모바일 칩 경쟁" },
        ...
        "TSM": [
          ...
          { ticker: "INTC", name: "Intel", nameKo: "인텔", reason: "파운드리 경쟁사" },
        ],
        // v9.22: 추가 관련 종목
        "AVGO": [
          { ticker: "NVDA", name: "NVIDIA", nameKo: "엔비디아", reason: "AI 반도체 1위" },
          { ticker: "MRVL", name: "Marvell", nameKo: "마벨", reason: "데이터센터 반도체 경쟁" },
          { ticker: "QCOM", name: "Qualcomm", nameKo: "퀄컴", reason: "통신 칩 경쟁사" },
          { ticker: "CRDO", name: "Credo", nameKo: "크리도", reason: "AI 연결 솔루션" },
        ],
        "PLTR": [
          { ticker: "AI", name: "C3.ai", nameKo: "씨쓰리에이아이", reason: "기업용 AI 플랫폼" },
          { ticker: "SNOW", name: "Snowflake", nameKo: "스노우플레이크", reason: "데이터 분석 플랫폼" },
          { ticker: "INOD", name: "Innodata", nameKo: "이노데이터", reason: "AI 데이터 라벨링" },
          { ticker: "BBAI", name: "BigBear.ai", nameKo: "빅베어에이아이", reason: "AI 분석 솔루션" },
        ],
        "INOD": [
          { ticker: "PLTR", name: "Palantir", nameKo: "팔란티어", reason: "AI 데이터 분석 대장" },
        ...
        "GLW": [
          ...
          { ticker: "AAPL", name: "Apple", nameKo: "애플", reason: "고릴라글라스 납품" },
        ...
        "COHR": [
          ...
          { ticker: "AVGO", name: "Broadcom", nameKo: "브로드컴", reason: "광통신 칩" },
          { ticker: "CRDO", name: "Credo", nameKo: "크리도", reason: "고속 연결 솔루션" },
        ],
        "CRDO": [
          { ticker: "AVGO", name: "Broadcom", nameKo: "브로드컴", reason: "AI 네트워크 칩 1위" },
          { ticker: "MRVL", name: "Marvell", nameKo: "마벨", reason: "데이터센터 반도체" },
          { ticker: "COHR", name: "Coherent", nameKo: "코히런트", reason: "광통신 장비" },
          { ticker: "NVDA", name: "NVIDIA", nameKo: "엔비디아", reason: "AI 반도체 대장" },
        ],
        "MRVL": [
          { ticker: "AVGO", name: "Broadcom", nameKo: "브로드컴", reason: "데이터센터 칩 경쟁" },
          { ticker: "NVDA", name: "NVIDIA", nameKo: "엔비디아", reason: "AI 반도체 1위" },
        ...
        "SMCI": [
          ...
          { ticker: "DELL", name: "Dell", nameKo: "델", reason: "서버 경쟁사" },
          { ticker: "HPE", name: "HP Enterprise", nameKo: "HPE", reason: "서버 경쟁사" },
        ...
        "IONQ": [
          ...
          { ticker: "IBM", name: "IBM", nameKo: "IBM", reason: "양자컴퓨터 선두" },
          { ticker: "GOOGL", name: "Alphabet", nameKo: "구글", reason: "양자 우위 달성" },
        ],
        "RGTI": [
        ...
        "SMR": [
          ...
          { ticker: "CEG", name: "Constellation", nameKo: "컨스털레이션", reason: "원전 운영사" },
        ...
        "ONDS": [
          ...
          { ticker: "PLTR", name: "Palantir", nameKo: "팔란티어", reason: "정부 계약 AI" },
        ],
        "TEM": [
          { ticker: "VEEV", name: "Veeva", nameKo: "비바", reason: "헬스케어 데이터" },
          { ticker: "INOD", name: "Innodata", nameKo: "이노데이터", reason: "AI 데이터" },
          { ticker: "EXAS", name: "Exact Sciences", nameKo: "이그젝트사이언스", reason: "진단 기술" },
          { ticker: "ILMN", name: "Illumina", nameKo: "일루미나", reason: "유전체 분석" },
        ],
        "RDW": [
        ...
        "SOUN": [
          { ticker: "PLTR", name: "Palantir", nameKo: "팔란티어", reason: "AI 소프트웨어 대장" },
          { ticker: "AI", name: "C3.ai", nameKo: "씨쓰리에이아이", reason: "기업용 AI" },
          { ticker: "BBAI", name: "BigBear.ai", nameKo: "빅베어에이아이", reason: "AI 분석" },
          { ticker: "INOD", name: "Innodata", nameKo: "이노데이터", reason: "AI 데이터" },
        ],
        "INTC": [
          ...
          { ticker: "TSM", name: "TSMC", nameKo: "TSMC", reason: "파운드리 위탁 생산" },
          { ticker: "QCOM", name: "Qualcomm", nameKo: "퀄컴", reason: "모바일 칩 경쟁" },
        ],
        "QCOM": [
