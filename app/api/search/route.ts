...
const krStockSearchMap: Record<string, { code: string; name: string; market: string }> = {
  ...
  // v9.24 확장 - 한화그룹
  // ═══════════════════════════════════════════════════════════════
  "한화비전": { code: "039570", name: "한화비전", market: "KOSDAQ" },
  "한화솔루션": { code: "009830", name: "한화솔루션", market: "KOSPI" },
  "한화생명": { code: "088350", name: "한화생명", market: "KOSPI" },
  "한화투자증권": { code: "003530", name: "한화투자증권", market: "KOSPI" },
  "한화갤러리아": { code: "027390", name: "한화갤러리아", market: "KOSPI" },
  "한화손해보험": { code: "000370", name: "한화손해보험", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 제약/바이오 추가
  // ═══════════════════════════════════════════════════════════════
  "삼성바이오에피스": { code: "326030", name: "삼성바이오에피스", market: "KOSPI" },
  "sk바이오사이언스": { code: "302440", name: "SK바이오사이언스", market: "KOSPI" },
  "에이비엘바이오": { code: "298380", name: "에이비엘바이오", market: "KOSDAQ" },
  "유한양행": { code: "000100", name: "유한양행", market: "KOSPI" },
  "녹십자": { code: "006280", name: "녹십자", market: "KOSPI" },
  ...
  "한미약품": { code: "128940", name: "한미약품", market: "KOSPI" },
  "대웅제약": { code: "069620", name: "대웅제약", market: "KOSPI" },
  "광동제약": { code: "009290", name: "광동제약", market: "KOSPI" },
  "일동제약": { code: "249420", name: "일동제약", market: "KOSPI" },
  "보령": { code: "003850", name: "보령", market: "KOSPI" },
  "동아에스티": { code: "170900", name: "동아에스티", market: "KOSPI" },
  "jw중외제약": { code: "001060", name: "JW중외제약", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 건설/부동산
  // ═══════════════════════════════════════════════════════════════
  "삼성엔지니어링": { code: "028050", name: "삼성엔지니어링", market: "KOSPI" },
  "삼성e&a": { code: "028050", name: "삼성엔지니어링", market: "KOSPI" },
  "gs건설": { code: "006360", name: "GS건설", market: "KOSPI" },
  "대우건설": { code: "047040", name: "대우건설", market: "KOSPI" },
  "현대엔지니어링": { code: "000720", name: "현대건설", market: "KOSPI" },
  "hdC현대산업개발": { code: "294870", name: "HDC현대산업개발", market: "KOSPI" },
  "현대산업개발": { code: "294870", name: "HDC현대산업개발", market: "KOSPI" },
  "dl이앤씨": { code: "375500", name: "DL이앤씨", market: "KOSPI" },
  "대림건설": { code: "375500", name: "DL이앤씨", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 식품/음료
  // ═══════════════════════════════════════════════════════════════
  "농심": { code: "004370", name: "농심", market: "KOSPI" },
  "오뚜기": { code: "007310", name: "오뚜기", market: "KOSPI" },
  "삼양식품": { code: "003230", name: "삼양식품", market: "KOSPI" },
  "하이트진로": { code: "000080", name: "하이트진로", market: "KOSPI" },
  "오리온": { code: "271560", name: "오리온", market: "KOSPI" },
  "빙그레": { code: "005180", name: "빙그레", market: "KOSPI" },
  "매일유업": { code: "267980", name: "매일유업", market: "KOSPI" },
  "풀무원": { code: "017810", name: "풀무원", market: "KOSPI" },
  "삼립": { code: "005500", name: "SPC삼립", market: "KOSPI" },
  "spc삼립": { code: "005500", name: "SPC삼립", market: "KOSPI" },
  ...
  "신세계": { code: "004170", name: "신세계", market: "KOSPI" },
  "이마트": { code: "139480", name: "이마트", market: "KOSPI" },
  "롯데쇼핑": { code: "023530", name: "롯데쇼핑", market: "KOSPI" },
  "현대백화점": { code: "069960", name: "현대백화점", market: "KOSPI" },
  "현백": { code: "069960", name: "현대백화점", market: "KOSPI" },
  "bgf리테일": { code: "282330", name: "BGF리테일", market: "KOSPI" },
  "씨유": { code: "282330", name: "BGF리테일", market: "KOSPI" },
  "gs리테일": { code: "007070", name: "GS리테일", market: "KOSPI" },
  "무신사": { code: "비상장", name: "무신사(비상장)", market: "비상장" },
  "쿠팡": { code: "CPNG", name: "쿠팡(미국상장)", market: "NYSE" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 화장품/뷰티
  // ═══════════════════════════════════════════════════════════════
  "lg생활건강": { code: "051900", name: "LG생활건강", market: "KOSPI" },
  "엘지생활건강": { code: "051900", name: "LG생활건강", market: "KOSPI" },
  "아모레g": { code: "002790", name: "아모레G", market: "KOSPI" },
  "코스맥스": { code: "192820", name: "코스맥스", market: "KOSPI" },
  "한국콜마": { code: "161890", name: "한국콜마", market: "KOSPI" },
  "클리오": { code: "237880", name: "클리오", market: "KOSDAQ" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 철강/금속
  // ═══════════════════════════════════════════════════════════════
  "현대제철": { code: "004020", name: "현대제철", market: "KOSPI" },
  "동국제강": { code: "001230", name: "동국제강", market: "KOSPI" },
  "세아베스틸": { code: "001430", name: "세아베스틸", market: "KOSPI" },
  "영풍": { code: "000670", name: "영풍", market: "KOSPI" },
  "풍산": { code: "103140", name: "풍산", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 자동차부품
  // ═══════════════════════════════════════════════════════════════
  "현대위아": { code: "011210", name: "현대위아", market: "KOSPI" },
  "현대오토에버": { code: "307950", name: "현대오토에버", market: "KOSPI" },
  "현대글로비스": { code: "086280", name: "현대글로비스", market: "KOSPI" },
  "만도": { code: "204320", name: "만도", market: "KOSPI" },
  "hl만도": { code: "204320", name: "만도", market: "KOSPI" },
  "한온시스템": { code: "018880", name: "한온시스템", market: "KOSPI" },
  "현대트랜시스": { code: "298040", name: "현대트랜시스", market: "KOSPI" },
  "에스엘": { code: "005850", name: "에스엘", market: "KOSPI" },
  "sl": { code: "005850", name: "에스엘", market: "KOSPI" },
  ...
  "에쓰오일": { code: "010950", name: "S-Oil", market: "KOSPI" },
  "s-oil": { code: "010950", name: "S-Oil", market: "KOSPI" },
  "gs칼텍스": { code: "비상장", name: "GS칼텍스(비상장)", market: "비상장" },
  "한화토탈에너지스": { code: "비상장", name: "한화토탈에너지스(비상장)", market: "비상장" },
  "금호석유화학": { code: "011780", name: "금호석유화학", market: "KOSPI" },
  "금호석유": { code: "011780", name: "금호석유화학", market: "KOSPI" },
  "롯데케미칼": { code: "011170", name: "롯데케미칼", market: "KOSPI" },
  "한화케미칼": { code: "009830", name: "한화솔루션", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - IT서비스/소프트웨어
  // ═══════════════════════════════════════════════════════════════
  "삼성sds": { code: "018260", name: "삼성SDS", market: "KOSPI" },
  "삼성에스디에스": { code: "018260", name: "삼성SDS", market: "KOSPI" },
  "lg씨엔에스": { code: "LGCNS", name: "LG CNS(비상장)", market: "비상장" },
  "lgcns": { code: "LGCNS", name: "LG CNS(비상장)", market: "비상장" },
  "sk씨앤씨": { code: "034730", name: "SK", market: "KOSPI" },
  "카카오엔터프라이즈": { code: "비상장", name: "카카오엔터프라이즈(비상장)", market: "비상장" },
  "위메이드맥스": { code: "101730", name: "위메이드맥스", market: "KOSDAQ" },
  "컴투스홀딩스": { code: "063080", name: "컴투스홀딩스", market: "KOSDAQ" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 방송/통신
  // ═══════════════════════════════════════════════════════════════
  "lg유플러스": { code: "032640", name: "LG유플러스", market: "KOSPI" },
  "엘지유플러스": { code: "032640", name: "LG유플러스", market: "KOSPI" },
  "skb": { code: "017670", name: "SK텔레콤", market: "KOSPI" },
  "cj이앤엠": { code: "130960", name: "CJ ENM", market: "KOSPI" },
  "cjenm": { code: "130960", name: "CJ ENM", market: "KOSPI" },
  "스카이라이프": { code: "053210", name: "스카이라이프", market: "KOSPI" },
  
  // ═══════════════════════════════════════════════════════════════
  // v9.24 확장 - 중소형 인기주
  // ═══════════════════════════════════════════════════════════════
  "셀트리온헬스케어": { code: "091990", name: "셀트리온헬스케어", market: "KOSPI" },
  "셀헬스": { code: "091990", name: "셀트리온헬스케어", market: "KOSPI" },
  "두산밥캣": { code: "241560", name: "두산밥캣", market: "KOSPI" },
  "두산로보틱스": { code: "454910", name: "두산로보틱스", market: "KOSPI" },
  "카카오페이증권": { code: "377300", name: "카카오페이", market: "KOSPI" },
  "토스": { code: "비상장", name: "비바리퍼블리카(비상장)", market: "비상장" },
  "비바리퍼블리카": { code: "비상장", name: "비바리퍼블리카(비상장)", market: "비상장" },
  "직방": { code: "비상장", name: "직방(비상장)", market: "비상장" },
  "야놀자": { code: "비상장", name: "야놀자(비상장)", market: "비상장" },
  "마켓컬리": { code: "비상장", name: "컬리(비상장)", market: "비상장" },
  "컬리": { code: "비상장", name: "컬리(비상장)", market: "비상장" },
};
